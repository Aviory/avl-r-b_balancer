       ...
       public class Node : ICloneable
        ...
        private void sort(Node p)
        {
            ...
            if (p.right != null && p.left != null)
            {
                ...
                {
                    Node tmp = p.right.right.left;
                    p.right.right.left = p.right;
                    p.right = p.right.right;
                    p.right.left.right = tmp;
                }
                if (p.left.balance < -1)
                {
                    Node tmp = p.left.left.right;
                    p.left.left.right = p.left;
                    p.left = p.left.left;
                    p.left.right.left = tmp;
                }
            }
